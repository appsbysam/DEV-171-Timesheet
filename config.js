...
(function () {
  const environments = {
    production: {environment:"production",isDevelopment:false,supabaseUrl:"https://cebgyyairqctbgrocxgl.supabase.co",supabaseKey:"sb_publishable_VFT7GrL1rJtmV0hv0CPrlg_qjZXq4d",pageTitle:"Café Staff Timesheet",appHeading:"Staff Timesheet",buildLabel:"",modeSuffix:"",manifestFile:"manifest-production.json",versionSuffix:""},
  ...
  window.addEventListener("DOMContentLoaded",()=>{
    for(const file of ["promotion-admin.js","notifications.js","notification-settings.js"]){const s=document.createElement("script");s.src=`${file}?v=${Date.now()}`;document.body.appendChild(s)}
  });
})();
